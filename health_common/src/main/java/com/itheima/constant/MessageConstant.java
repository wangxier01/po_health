...
public class MessageConstant {
    ...
    public static final String PLEASE_VALIDATECODE_INPUT = "请先输入验证码再提交";
    ...
    public static final String ORDER_FAIL = "预约Fail";
    ...
    public static final String  UNFILLED_ORDER= "未到诊";
